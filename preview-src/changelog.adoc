...
[role="date-2025-July-12 label-ingress label-bugfix"]
== Entry A
...
[role="date-2025-06-12 label-feature label-bugfix label-butt label-tits label-nipples label-arse label-releaseIt"]
== Entry B
